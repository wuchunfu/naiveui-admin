...
declare global {
  // @ts-ignore
  export type { Component, ComponentPublicInstance, ComputedRef, DirectiveBinding, ExtractDefaultPropTypes, ExtractPropTypes, ExtractPublicPropTypes, InjectionKey, PropType, Ref, MaybeRef, MaybeRefOrGetter, VNode, WritableComputedRef, App, ComponentPublicInstanceCustom, ComponentInternalInstance } from 'vue'
  import('vue')
  // @ts-ignore
  ...
  import('vue-router')
  // @ts-ignore
  export type { NLocale, FormInst, arkTheme, MenuOption, NDateLocale, DropdownOption, PopoverPlacement, GlobalThemeOverrides } from 'naive-ui'
  import('naive-ui')
}
