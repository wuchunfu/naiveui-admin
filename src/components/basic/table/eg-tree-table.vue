...
function getTableHeight(num?: number) {
  if (num) {
    tableHeight.value = window.innerHeight - 108 - num - 20 - headRef.value?.height - 80 - 86 - 12
  } else {
    tableHeight.value = window.innerHeight - 108 - formRef.value?.height - headRef.value?.height - 80 - 86 - 6
  }
}
