<template>
  <div class="unt-search-container z-36">
      ...
      >
        <template #suffix>
          <SvgIcon
              ...
              class="flex-center h-24px w-24px text-24px cursor-pointer"
              color="#007bff"
              @click="handleEnter"
          />
        </template>
...
<style>
.unt-search-container .tabs-content .n-tabs-nav-scroll-content {
  border-bottom: none !important;
}

.unt-search-container .tabs-content .n-tabs-bar {
  height: 3px;
  background: #fff;
}
</style>
